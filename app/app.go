...
import (
	...
	"powpos/docs"
	checkpointmodulekeeper "powpos/x/checkpoint/keeper"
	powposmodulekeeper "powpos/x/powpos/keeper"
)
...
type App struct {
	*runtime.App
	...
	PowposKeeper     powposmodulekeeper.Keeper
